<div class="main main-raised">
	<div class="container mainn-raised slider" style="width:100%;">
		...
		<div id="myCarousel" class="carousel slide" data-ride="carousel">
			...
			<div class="carousel-inner px-5">
				...
				<div class="item active">
					<img src="img/slider_1.webp" alt="Los Angeles" style="width:100%;">
				...
				<div class="item">
					<img src="img/slider_3.webp" alt="New York" style="width:100%;">

				</div>
				<div class="item">
					<img src="img/slider_1.webp" alt="New York" style="width:100%;">

				</div>
				<div class="item">
					<img src="img/slider_2.webp" alt="New York" style="width:100%;">
						...
						<div id="get_product_home2">
							...
							<div class="product-widget">
								...
								<div class="product-body">
									...
									<h4 class="product-price">900MMK <del class="product-old-price">9000MMK</del></h4>
								</div>
							</div>
							<!-- /product widget -->
				...
				<div class="col-md-4 col-xs-6">
					...
					<div class="products-widget-slick" data-nav="#slick-nav-4">
						...
						<div>
							...
							<div class="product-widget">
								<div class="product-img">
									<img src="./img/apple-iphone-15-pro-max.jpg" alt="">
								</div>
								<div class="product-body">
									<p class="product-category">Category</p>
									<h3 class="product-name"><a href="#">product name goes here</a></h3>
